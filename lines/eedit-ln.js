class eEditor {
  ...
  basecss(data) {
    ...
    this.t.setAttribute("spellcheck", "false")
  ...
  overlay(e) {
    ...
    e.style.paddingLeft = this.data.offset
  ...
  ln(theme) {
    // this.p.style.paddingRight = theme.space
    this.t.style.textIndent = theme.space
    // this.sss = theme.space
